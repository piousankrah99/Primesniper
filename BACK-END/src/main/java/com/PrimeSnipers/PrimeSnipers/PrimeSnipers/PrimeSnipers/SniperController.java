...
public class SniperController {
 ...
 @GetMapping("/primeSnipers")
    ...
    @GetMapping("/{id}")
    @ResponseBody
    public Optional<Snipers> getSniper(@PathVariable("id") Long id, Model model){
        model.addAttribute("sniper", new Snipers());
...
//
    ...
    public String showUpdateSniperForm(@PathVariable("id") Long id, Model model) {
        ...
        model.addAttribute("sniper", sniperService.getSniperById(id));
    ...
    public Snipers updateSniper(@PathVariable("id")Long id, @RequestBody Snipers sniper, Model model) {
        ...
        model.addAttribute("sniper", sniper);
            ...
            return sniperService.updateSniper(existingSniper);
        }
    ...
    public String showDetailModal(@PathVariable("id") Long id, Model model) {
        ...
        model.addAttribute("sniperDetails", sniperService.getSniperById(id));
        ...
        public ResponseEntity<String> deleteSnipers (@PathVariable Long id){
                ...
                Optional <Snipers> existingSniper = sniperService.getSniperById(id);
